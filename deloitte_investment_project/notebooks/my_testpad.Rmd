...
gdp_phw_OECD %>% 
  ...
  # scale_colour_manual(values = cbb_palette) +
  ggtitle(
    "GDP per hour worked (index 2010)",
...
gdp_phw_OECD %>% 
  ...
  labs(
    x = "\n Year", 
    y = "GDP per hour worked (index 2010) \n"
  ) 
...
tidy_overqualified_workers %>%
  ...
  # scale_colour_brewer(palette = "Dark2")
  scale_colour_manual(values = cbb_palette) +
  ggtitle("Percentage of overqualified workers") +
  labs(
    x = "\n Year", 
    y = "Percentage (%) \n"
  ) 
...
tidy_underqualified_workers %>%
  ...
  # scale_colour_brewer(palette = "Dark2")
  scale_colour_manual(values = cbb_palette) +
  ggtitle("Percentage of underqualified workers") +
  labs(
    x = "\n Year", 
    y = "Percentage (%) \n"
  ) 
...
tidy_qualified_workers %>%
  ...
  # scale_colour_brewer(palette = "Dark2")
  scale_colour_manual(values = cbb_palette) +
  ggtitle("Percentage of well-matched workers") +
  labs(
    x = "\n Year", 
    y = "Percentage (%) \n"
  ) 
