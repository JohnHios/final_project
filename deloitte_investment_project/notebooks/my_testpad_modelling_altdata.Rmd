...
mod_interact <- lm(gdp_phw_usd ~ 1 + cultasset_bil_usd + infrastuct_bil_usd +
...
```{r}
model_auto_kfold <- train(gdp_phw_usd ~ cultasset_bil_usd + infrastuct_bil_usd +
                          intelprop_bil_usd + dwelling_bil_usd +
                          infrastuct_bil_usd:cultasset_bil_usd +
                          dwelling_bil_usd:infrastuct_bil_usd,
                        data = prod_uk_trim,
...
```{r}
model_auto_kfold$resample
```

```{r}
tibble(
  model = "automatically selected model",
  RMSE = mean(model_auto_kfold$resample$RMSE),
  Rsquared = mean(model_auto_kfold$resample$Rsquared)
)
```
