...
Where possible, more recent versions of the data sets were sought in an effort to use the most up to date information for this report. As a result, out of the 7 files used in the the analysis phase, only 1 file was classified as internal (provided by the organisation) and the remaining 6 files were classed as external (not sourced from the organisation's data). A summary of the files used is provided in the table below.
...
+ ONS refers to the Office for Nations Statistics (https://www.ons.gov.uk/)
...
+ Categorical character type 
  + nominal: for instance country names and investment sector
  + ordinal: date-time
...
The format types of the data used in the analysis is shown in the table above. Out of the 7 files used: 

+ 6 data files were in .csv format and downloaded from the OECD online data library.
