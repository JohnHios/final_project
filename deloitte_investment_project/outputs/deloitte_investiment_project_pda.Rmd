...
The data cleaning R scripts are available for review within the `scripts` folder inside the project's GitHup repo. The data visualisations (run charts, bar-plots, choropleth map) and the developed machine learning outputs (K-means clustering and linear regression model) are available for review in individual R notebooks within the `notebooks` folder.


### UK Productivity


```{r, echo = FALSE, fig.cap = "Figure 5: Run chart of", out.width = '80%'}
knitr::include_graphics("images/G7_cross_country_gdp_phw.png")
```

```{r, echo = FALSE, fig.cap = "Figure 6: Bar plot of", out.width = '80%'}
knitr::include_graphics("images/cross_country_gdp_phw_2020.png")
```

```{r, echo = FALSE, fig.cap = "Figure 7: Bar plot of", out.width = '80%'}
knitr::include_graphics("images/european_countries_by_gdp_share_2018.png")
```

```{r, echo = FALSE, fig.cap = "Figure 8: Bar plot of", out.width = '80%'}
